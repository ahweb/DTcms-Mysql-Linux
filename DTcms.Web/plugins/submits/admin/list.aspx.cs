...
namespace DTcms.Web.Plugin.submits.admin
{
    public partial class list : DTcms.Web.UI.ManagePage
    {
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("list.aspx", "category_id={0}&keywords={1}", ddlCategoryId.SelectedValue, txtKeywords.Text));

        }

        //筛选类别
        protected void ddlCategoryId_SelectedlistChanged(object sender, EventArgs e)
        {
            Response.Redirect(Utils.CombUrlTxt("list.aspx", "category_id={0}&keywords={1}",ddlCategoryId.SelectedValue, this.keywords));
        }
        ...
        protected void lbtnUnLock_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("批量审核成功！", Utils.CombUrlTxt("list.aspx", "keywords={0}", this.keywords), "Success");
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！", Utils.CombUrlTxt("list.aspx", "keywords={0}", this.keywords), "Success");
        }
