...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("script>\r\n<script type=\"text/javascript\">\r\n$(function(){\r\n	//初始化发表评论表单\r\n	AjaxInitForm('#feedbackplus_form', '#btnSubmit', 1);\r\n});\r\n</");
	templateBuilder.Append("script>\r\n</head>\r\n\r\n<body>\r\n<!--Header-->\r\n");
	...
	templateBuilder.Append("\r\n        <li>\r\n          <h4><a href=\"");
	templateBuilder.Append(linkurl("feedbackplus"));
	...
	DataTable feedbackplusList = new DTcms.Web.Plugin.FeedbackPlus.feedbackplus().get_feedbackplus_list(10, page, "", out totalcount);

	string pagelist = get_page_link(10, page, totalcount, "feedbackplus", "__id__");

	foreach(DataRow dr in feedbackplusList.Rows)
	{
