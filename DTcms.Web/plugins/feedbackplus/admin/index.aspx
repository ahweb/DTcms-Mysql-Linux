<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="DTcms.Web.Plugin.FeedbackPlus.admin.index" %>
    ...
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          ...
          <li><a class="save" href="install.aspx"><i></i><span>配置</span></a></li>
        </ul>
      </div>
      <div class="r-list">
