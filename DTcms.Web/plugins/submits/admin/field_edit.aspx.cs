...
{
    public partial class field_edit: Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(_action) && _action == DTEnums.ActionEnum.Edit.ToString())
            {
                ...
                if (!new BLL.submits_field().Exists(this.id))
                {
        ...
        private void ShowInfo(int _id)
        {
            ...
            Model.submits_field model = bll.GetModel(_id);
        ...
        private bool DoAdd()
        {
            ...
            if (bll.Add(model) > 0)
            {
                AddAdminLog(DTEnums.ActionEnum.Add.ToString(), "表单添加扩展字段:" + model.title); //记录日志
                result = true;
            }
            return result;
        }
        ...
        private bool DoEdit(int _id)
        {
            ...
            if (bll.Update(model))
            {
                AddAdminLog(DTEnums.ActionEnum.Add.ToString(), "表单修改扩展字段:" + model.title); //记录日志
                result = true;
            }
        ...
        protected void btnsubmits_Click(object sender, EventArgs e)
        {
            if (action == DTEnums.ActionEnum.Edit.ToString()) //修改
            {
                ...
                JscriptMsg("修改扩展字段成功！", "field_list.aspx");
            }
            else //添加
            {
                ...
                JscriptMsg("添加扩展字段成功！", "field_list.aspx");
            }
        }
