<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="field_edit.aspx.cs" Inherits="DTcms.Web.Plugin.submits.admin.field_edit" ValidateRequest="false" %>
...
<div class="tab-content">
  ...
  <dl>
    <dt>字段列名</dt>
    <dd><asp:TextBox ID="txtName" runat="server" CssClass="input normal" datatype="/^[a-zA-Z0-9\-\_]{2,50}$/" sucmsg=" " ajaxurl="/plugins/submits/ajax.ashx?action=submits_field_validate"></asp:TextBox> <span class="Validform_checktip">*字母、下划线，不可修改</span></dd>
  </dl>
...
<div class="page-footer">
  <div class="btn-list">
    <asp:Button ID="btnsubmits" runat="server" Text="提交保存" CssClass="btn" onclick="btnsubmits_Click" />
...
<!--submits Plugin by www.chenpan.com.cn -->
